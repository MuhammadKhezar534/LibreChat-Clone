...
/** Startup config including optional prompt presets (may not be in built types until data-provider is rebuilt) */
type StartupConfigWithPresets = TStartupConfig & {
  promptPresets?: Array<{ label: string; prompt: string }>;
};
import { PresetsMenu, HeaderNewChat, OpenSidebar } from './Menus';
import ModelSelector from './Menus/Endpoints/ModelSelector';
import PromptPresetDropdown from './Menus/PromptPresetDropdown';
