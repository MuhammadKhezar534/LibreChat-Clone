...
export const interfaceSchema = z
  .object({
    ...
    remoteAgents: z
      ...
      .optional(),
    /** Predefined prompt presets (label + prompt) for the header dropdown. */
    promptPresets: z
      .array(
        z.object({
          label: z.string(),
...
export type TStartupConfig = {
  ...
  /** Predefined prompt presets (label + system prompt). Loaded from PROMPT_PRESETS env (JSON) or interface.promptPresets in config. */
